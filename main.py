...
def registration():
    if request.method == 'POST':
        ...
        password_confirm = userDetails['password-confirm']
        ...
        if ver:
            ...
            if password == password_confirm:
                ...
                cur.execute("INSERT INTO users(first_name, email, password) VALUES (%s, %s, %s)", (first_name, email, password))
...
@app.route('/edit_user', method=['GET','POST'])
def edit_user():
    if session:
        cur = mysql.connection.cursor()
        cur.execute()
